/*
Deployment script for DoyGyDatabase
...
:setvar DatabaseName "DoyGyDatabase"
:setvar DefaultFilePrefix "DoyGyDatabase"
...
GO
PRINT N'Creating [dbo].[Stduent]...';


GO
CREATE TABLE [dbo].[Stduent] (
    [StduentId]  NVARCHAR (50) NOT NULL,
    [FirstName]  NVARCHAR (50) NOT NULL,
    [LastName]   NVARCHAR (50) NOT NULL,
    [MacAddress] NVARCHAR (50) NULL,
    [IssueDate]  DATETIME      NULL,
    PRIMARY KEY CLUSTERED ([StduentId] ASC)
);


GO
PRINT N'Creating unnamed constraint on [dbo].[Stduent]...';


GO
ALTER TABLE [dbo].[Stduent]
